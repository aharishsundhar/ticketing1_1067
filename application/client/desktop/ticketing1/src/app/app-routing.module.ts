...
{ path : 'addseverity1', loadChildren: () => import('./addseverity1/addseverity1.module').then(m => m.Addseverity1Module), canActivate: [AuthGuard] } , 
{ path : 'addtypes1', loadChildren: () => import('./addtypes1/addtypes1.module').then(m => m.Addtypes1Module), canActivate: [AuthGuard] } , 
{ path : 'addticket1', loadChildren: () => import('./addticket1/addticket1.module').then(m => m.Addticket1Module), canActivate: [AuthGuard] } , 
];
